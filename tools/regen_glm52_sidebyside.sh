...
python3 callorder_sidebyside.py \
  ...
  --title "GLM-5.2 decode — call order, ONE forward per side (SGLANG step[DECODE bs=64] | ATOM decode[bs=64 tok=64 d=64]); NOT aligned. Σ_ms/Cnt = per-call-site within that single forward, same scope as the compare_glm52 buckets at the bottom. SGLANG_old_30575=27.8ms | ATOM=25.0ms"
