...
LOG=/home/jacchang/SGLang-benchmarks/tmp/logs/router_gemm_allM.log
mkdir -p "$(dirname "$LOG")"
...
cd /sgl-workspace
python -u /home/jacchang/SGLang-benchmarks/tools/glm53_bench_router_gemm_allM.py > "$LOG" 2>&1
echo "EXIT=$?" >> "$LOG"
